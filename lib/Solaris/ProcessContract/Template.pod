...
See L<Solaris::ProcessContract::Flags/"Param Flags"> for a list of available
...
See L<Solaris::ProcessContract::Flags/"Event Flags"> for a list of available
event flags.
...
This allows you to control which events will cause both this contract and the
ones above it in the hierarchy to be marked as critical.
...
one you have and create a new instace, use L<"/reset"> to start this template
over.
